...
const Results: React.FC = () => {
  return (
    <div className="flex items-center justify-center h-auto bg-white">
      <div className="w-2/3 bg-gradient-to-b my-10 from-[#F7C95F] to-[#FDB235] rounded-[30px] p-10 flex flex-col justify-center">
      ...
      <div className="w-2/3 bg-gradient-to-b my-8 from-[#F7C95F] to-[#FDB235] rounded-[30px] p-10 flex flex-col justify-center">
        <h2 className="text-[43px] font-inter font-extrabold text-[#191847] mb-4">
          Resultados en cifras.
        </h2>
        <p className="text-3xl font-normal text-[#191847] mb-6">
      ...
      <div className="bg-gradient-to-b my-10 from-[#F7C95F] to-[#FDB235] rounded-[30px] p-10 flex flex-col justify-center">
        <h2 className="text-[43px] font-inter font-extrabold text-[#191847] mb-4">
          Resultados en cifras.
        </h2>
        <p className="text-3xl font-normal text-[#191847] mb-6">
